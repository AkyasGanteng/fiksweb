...
@section('title', 'Edit Pemasukan Stok')
...
<div class="container">
    ...
    <form action="{{ route('pemasukan.update', $pemasukan->id) }}" method="POST">
        ...
        <textarea id="keterangan" name="keterangan" rows="3">{{ old('keterangan', $pemasukan->keterangan) }}</textarea>

        <button type="submit">Update Pemasukan</button>
    </form>

    <a href="{{ route('pemasukan.index') }}" class="btn-secondary">Batal</a>
</div>
@endsection
